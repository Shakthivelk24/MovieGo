...
const Footer = () => {
  return (
    <div>
      <footer class="flex flex-col items-center justify-center w-full py-20 bg-gradient-to-b from-[#060012] to-[#602c0b] text-white/70">
        <svg
          width="157"
          height="40"
          viewBox="0 0 157 40"
        ...
        >
          {/* <!-- Logo image --> */}
          <image href="/logo.png" x="0" y="4" width="40" height="40" />
          {/* 
  <!-- MovieGo text --> */}
          <text
            x="42"
        ...
        <p class="mt-4 text-center">
          Copyright © 2025 <a href="https://prebuiltui.com">MovieGo</a>. All
          rights reservered.
        </p>
